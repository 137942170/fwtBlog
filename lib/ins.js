      ...
      var render = function render(res) {
        ...
        for (var j = 0, len2 = res.list.length; j < len2; j++) {
          ...
          for (var i = 0, len = data.link.length; i < len; i++) {
            ...
            var minSrc = 'https://raw.githubusercontent.com/https://github.com/137942170/Blog_Album/master/min_photos/' + data.link[i];
			
           // var src = 'https://raw.githubusercontent.com/yourgithub/Blog_Album/master/photos/' + data.link[i];
            var src = 'https://raw.githubusercontent.com/https://github.com/137942170/Blog_Album/master/photos/' + data.link[i];
            ...
            liTmpl += '<figure class="thumb" itemprop="associatedMedia" itemscope itemtype="http://schema.org/ImageObject">\
                  <a href="' + minSrc + '" itemprop="contentUrl" data-size="1080x1080" data-type="' + type + '" data-target="' + minSrc + '">\
                    <img class="reward-img" data-type="' + type + '" data-src="' + minSrc + '" src="/fwtBlog/fwtBlog/lib/ins/lib/album/assets/empty.png" itemprop="thumbnail" onload="lzld(this)">\
                  </a>\
